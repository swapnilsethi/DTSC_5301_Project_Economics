...
ujas_regression_1 <- ujas_regression1 %>% mutate(
  stimulus checks = (if (date < ymd("2020-04-14")) {
    0
  } else if (date<ymd("2020-05-01")) { 
    1200
  } else if (date< ymd("2021-01-03")) {
    0
  } else if (date < ymd("2021-01-19")) {
    600
  } else if (date < ymd())
...
ujas_df1<- left_join(affinity_daily_df)
```
